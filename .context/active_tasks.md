...
| TMX-3604-save-toast | Surface segment-save failures via toast (A3 mutation-error class; HITL-correction audit-event path) | Frontend | XS | 2 — **[Done, pending commit + push]** — see `.context/loops/TMX-3604-save-toast.md` |
