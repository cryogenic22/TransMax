...
| TMX-3604-delete-toast | Surface delete-job failures via toast (A3 mutation-error class; first ticket pivoting from fetch-sweep) | Frontend | XS | 2 — **[Done, pending commit + push]** — see `.context/loops/TMX-3604-delete-toast.md` |
