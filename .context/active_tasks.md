...
| TMX-3604-doc-review-err | Surface fetch errors on document review page (A3 fix; final ticket of the silent-fallback sweep) — NB: prefix collides with parent TMX-3604 (design-system migration) | Frontend | XS | 2 — **[Done, pending commit + push]** — see `.context/loops/TMX-3604-doc-review-err.md` |
