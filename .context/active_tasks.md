...
| TMX-3604-download-toast | Surface download failures via toast (A3 mutation-error class; covers JobsView + documents/[id] download buttons in one commit) | Frontend | XS | 2 — **[Done, pending commit + push]** — see `.context/loops/TMX-3604-download-toast.md` |
